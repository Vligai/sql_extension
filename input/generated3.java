...
arr_str = "(mf_struct[i].cust).equals(r.cust), (mf_struct[i].cust).equals(r.cust) && (r.state).equals(\"NJ\"), (mf_struct[i].cust).equals(r.cust) && (r.state).equals(\"NY\"), null, null, null, null, null, null, null, null, null, null, null, null";
my_input[4]=arr_str.split("\\s*,\\s*");
arr_str = "((double)mf_struct[i].sum_2_quant/ mf_struct[i].count_2_quant)<((double)mf_struct[i].sum_1_quant/ mf_struct[i].count_1_quant), null, null, null, null, null, null, null, null, null, null, null, null, null, null";
my_input[5]=arr_str.split("\\s*,\\s*");
arr_str = "r.year==1991, null, null, null, null, null, null, null, null, null, null, null, null, null, null";
...
if((counter2==1) &&((mf_struct[i].cust).equals(r.cust) && (r.state).equals("NJ"))){
