...
String arr_str;
arr_str = "2, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null";
...
arr_str = "sum_0_quant, count_0_quant, sum_1_quant, count_1_quant, sum_2_quant, count_2_quant, null, null, null, null, null, null, null, null, null, null, null, null, null, null";
my_input[3]=arr_str.split("\\s*,\\s*");
arr_str = "(mf_struct[i].cust).equals(r.cust), (mf_struct[i].cust).equals(r.cust) && (r.state).equals(\"CT\"), (mf_struct[i].cust).equals(r.cust) && (r.state).equals(\"NY\"), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null";
my_input[4]=arr_str.split("\\s*,\\s*");
arr_str = "((double)mf_struct[i].sum_2_quant/ mf_struct[i].count_2_quant)<((double)mf_struct[i].sum_1_quant/ mf_struct[i].count_1_quant), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null";
			...
			for (ii = 0; ii < max; ii++) {
				...
				for (i = 0; i < max; i++) {
					if (mf_struct[i] == null)
						break;
						/* generated code */
if((counter2==1) &&((mf_struct[i].cust).equals(r.cust) && (r.state).equals("CT"))){
mfstruct_gen.update_mfstruct(r,i,counter2);
}
if((counter2==2) &&((mf_struct[i].cust).equals(r.cust) && (r.state).equals("NY"))){
mfstruct_gen.update_mfstruct(r,i,counter2);
}
					/* end generated code */
					}
...
try{
System.out.println(mf_struct[i].cust+" "+ ((double)mf_struct[i].sum_1_quant/ mf_struct[i].count_1_quant)+ " "+ ((double)mf_struct[i].sum_2_quant/ mf_struct[i].count_2_quant));
}catch (Exception e){ System.out.println(e.getMessage());}}else{
if(((double)mf_struct[i].sum_2_quant/ mf_struct[i].count_2_quant)<((double)mf_struct[i].sum_1_quant/ mf_struct[i].count_1_quant)){
